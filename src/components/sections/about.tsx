            ...
            <div className="lg:col-span-7 lg:pr-8 lg:border-r border-cyan-300/25 dark:border-cyan-300/20">
              <div className="space-y-6 text-zinc-800 dark:text-zinc-100">
                <p className="text-base leading-8 md:text-lg md:leading-8 font-medium text-zinc-800 dark:text-zinc-200">
                  Soy estudiante de quinto semestre de Ingenieria de Software y
                  actualmente me desempeno como Ingeniero Fullstack de IA,
                  enfocado en crear aplicaciones web modernas, productos
                  digitales escalables y agentes de inteligencia artificial que
                ...
                <p className="text-base leading-8 md:text-lg md:leading-8 font-medium text-zinc-700 dark:text-zinc-300">
                  Me interesa participar en todo el proceso de desarrollo,
                  desde la idea y la definicion de la solucion hasta la
                  construccion de productos funcionales, bien pensados y
                  orientados al impacto.
                </p>
                <p className="text-base leading-8 md:text-lg md:leading-8 font-medium text-zinc-700 dark:text-zinc-300">
                  Me caracterizo por una mentalidad de aprendizaje constante,
                  disciplina y mejora continua para construir tecnologia con
                  valor real.
                </p>
              </div>
              ...
              <div className="mt-8 grid grid-cols-2 sm:grid-cols-3 gap-4">
                {[
                  ...
                  { value: "24+", label: "Tecnologias Clave" },
                ].map((item) => (
                  <div
                    key={item.label}
