...
type ExperienceKind = "Laboral" | "Academica";
...
const TIMELINE: TimelineItem[] = [
  {
    ...
    description:
      "Diseno, desarrollo e implementacion de soluciones con inteligencia artificial, automatizacion y desarrollo full stack. Enfoque en agentes de IA, integracion de herramientas y plataformas escalables orientadas a negocio.",
  },
  {
    kind: "Laboral",
    title: "Monitor academico y desarrollador",
    org: "Universidad Cooperativa de Colombia",
    period: "Febrero 2025 - Agosto 2025",
    description:
      "Apoyo academico y tecnico en procesos institucionales, gestion operativa de eventos y desarrollo de soluciones digitales para optimizar registros y operaciones internas.",
  },
  {
    kind: "Academica",
    ...
    description:
      "Formacion profesional en desarrollo de software, arquitectura, bases de datos, ingenieria de requisitos y construccion de productos tecnologicos.",
  },
  {
    kind: "Academica",
    title: "Tecnico laboral por competencias en sistemas informaticos",
    org: "Idetec de Narino",
    period: "Finalizado",
    description:
      "Fundamentos practicos de sistemas informaticos, soporte tecnico y herramientas para implementacion de soluciones digitales.",
  },
  {
    kind: "Academica",
    title: "Auxiliar operador en sistemas informaticos",
    org: "Idetec de Narino",
    period: "Finalizado",
    description:
      "Formacion orientada a operacion de sistemas, gestion basica de infraestructura y apoyo tecnico en entornos de trabajo.",
  },
  {
    kind: "Academica",
    title: "Diplomado en herramientas web 2.0 y redes informaticas",
    org: "Idetec de Narino",
    period: "Finalizado",
    description:
      "Capacitacion en herramientas web, conectividad y conceptos de redes para fortalecer el despliegue de servicios digitales.",
  },
];
    ...
    <section id="experience" className="relative z-[2] min-h-screen w-full py-24 md:py-32">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-10">
        <Link href="#experience">
          <div>
            <h2 className="section-title">EXPERIENCIA ACADEMICA Y LABORAL</h2>
            <div className="section-title-line" />
          </div>
        </Link>

        <p className="mx-auto mt-6 max-w-3xl text-center text-sm md:text-base text-zinc-700 dark:text-zinc-300 leading-7">
          Recorrido de experiencia profesional y formacion academica,
          organizado como linea de tiempo.
        </p>
