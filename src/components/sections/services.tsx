...
const SERVICES: Service[] = [
  {
    ...
    Icon: AppWindow,
    gradient: "from-cyan-400/35 via-sky-400/18 to-transparent",
    borderGlow: "group-hover:border-cyan-300/55",
  },
  {
    title: "Sistemas con inteligencia artificial",
    description: "Integracion de modelos, APIs y funcionalidades AI-first.",
    Icon: BrainCircuit,
    gradient: "from-sky-400/35 via-blue-400/18 to-transparent",
    borderGlow: "group-hover:border-sky-300/55",
  },
  {
    title: "Desarrollo full stack",
    description: "Frontend, backend, bases de datos y logica de negocio.",
    Icon: Layers3,
    gradient: "from-emerald-400/35 via-teal-400/18 to-transparent",
    borderGlow: "group-hover:border-emerald-300/55",
  },
  {
    title: "APIs e integraciones",
    description: "Conexion de servicios y automatizacion de flujos digitales.",
    Icon: Workflow,
    gradient: "from-amber-400/35 via-orange-400/18 to-transparent",
    borderGlow: "group-hover:border-amber-300/55",
  },
  {
    title: "Automatizacion de procesos",
    description: "Optimizacion de tareas y operaciones mediante tecnologia.",
    Icon: Gauge,
    gradient: "from-blue-400/35 via-indigo-400/18 to-transparent",
    borderGlow: "group-hover:border-blue-300/55",
  },
  {
    title: "CRM, dashboards y plataformas internas",
    description: "Herramientas de gestion para negocio y operacion.",
    Icon: LayoutDashboard,
    gradient: "from-cyan-400/35 via-slate-300/18 to-transparent",
    borderGlow: "group-hover:border-cyan-200/55",
  },
  {
    title: "MVPs para startups",
    description: "Productos listos para validar ideas y crecer.",
    Icon: Rocket,
    gradient: "from-lime-400/35 via-green-400/18 to-transparent",
    borderGlow: "group-hover:border-lime-300/55",
  },
  {
    title: "Interfaces y experiencia de usuario",
    description: "Diseno e implementacion de experiencias claras y funcionales.",
    Icon: Palette,
    gradient: "from-sky-400/35 via-cyan-400/18 to-transparent",
    borderGlow: "group-hover:border-sky-300/55",
  },
];
...
const ServicesSection = () => {
  return (
    <section id="services" className="relative z-[2] min-h-screen w-full py-24 md:py-32">
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        ...
        <p className="mx-auto mt-6 max-w-3xl text-center text-sm md:text-base text-zinc-700 dark:text-zinc-300 leading-7">
          Soluciones tecnologicas que desarrollo con enfoque en producto,
          ...
          {SERVICES.map((service, idx) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                >
                  <service.Icon className="h-5 w-5 text-zinc-900 dark:text-zinc-100" />
                </motion.div>
